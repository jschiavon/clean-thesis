...
Moreover, we can reference also \cref{thm:important} or \cref{eq:difficultmath} or even \crefrange{thm:important}{thm:corollary} or \cref{thm:important,thm:small,def:first}. \Cref{eq:difficultmath} appears at the beginning of a sentence, while we can add that \cref{sec:two-one} is at \cpageref{sec:two-one}.
